...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center overflow-hidden relative px-4 py-6 sm:px-0 sm:py-0">
      ...
      {/* Main content */}
      <div className="w-full max-w-xs sm:max-w-sm md:max-w-md bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-5 sm:p-8 border border-white/50 z-10">
        {/* Logo with glow effect */}
        <div className="flex flex-col items-center justify-center gap-3 mb-6 sm:mb-10 relative">
          <div className="relative w-16 h-16 sm:w-24 sm:h-24 drop-shadow-glow">
        ...
        {/* Main Content */}
        <div className="space-y-3 sm:space-y-4 text-center mb-6 sm:mb-10">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Supercharge Your Content Marketing with AI</h2>
        ...
        {!submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3">
              <div className="relative">
                <Input
                  ...
                  className="h-12 sm:h-14 pl-4 pr-12 border-gray-300 bg-white/70 backdrop-blur-sm focus-visible:ring-blue-500 rounded-lg text-sm sm:text-base"
                  value={email}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEmail(e.target.value)}
                  required
                  suppressHydrationWarning
                />
                <div className="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 sm:w-6 sm:h-6 text-purple-500" suppressHydrationWarning>
                  <svg
              ...
              <Button
                type="submit"
                className="h-12 sm:h-14 w-full text-sm sm:text-base font-medium bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 group relative overflow-hidden"
              >
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-5 sm:p-8 rounded-lg text-center border border-purple-100">
            <div className="mb-4 inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-r from-blue-100 to-purple-100">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">Thank you for joining!</h3>
            <p className="text-sm sm:text-base text-gray-600 mb-2">We've received your email and will keep you updated on our launch.</p>
            <p className="text-xs sm:text-sm text-blue-600">Redirecting you to our community page...</p>
          </div>
        )}
        ...
        <div className="mt-6 sm:mt-10 space-y-4 sm:space-y-6">
          <div className="flex items-center justify-center space-x-4 sm:space-x-10">
            <a
              ...
              className="text-xs sm:text-sm text-gray-500 hover:text-gray-800 transition-colors duration-200 group flex items-center gap-1"
            >
              Social
